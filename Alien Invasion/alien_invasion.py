...
class AlienInvasion:
	"""Overall clas to manage game assets an behavior."""
	...
	def __init__(self):
		...
		# Set the background color of the pop-up screen.
	...
	def _check_keydown_events(self, event):
		"""ship movement for a key press event."""
	...
	def _check_keyup_events(self, event):
		"""ship stops movement for a key up event."""
		if event.key == pygame.K_RIGHT:
	...
	def _ship_hit(self):
		...
		if self.stats.ships_left > 0:
			...
			# Create a new fleet and enter the ship.
			self._create_fleet()
			self.ship.center_ship()
	...
	def _check_bullet_alien_collisions(self):
		...
		# If collision detected, remove bullet and alien.
	...
	def _update_aliens(self):
		...
		then update he positions of all aliens in the fleet"""
		...
		# Look for aliens hitting the bottom of he screen.
